...
grand.res<-rbind(grand.res,res)
	...
	subs<-(param_sex==0.4)&(param_selfish==10)
	plot(param_lethality[subs],grand.res[subs,"mean_21_50"],ylim=c(0.5,1.0),ylab="% Yield",xlab="",type="l",las=1,cex.axis=cx,cex.lab=cx,lty=3)
	subs<-(param_sex==0.4)&(param_selfish==20)
	lines(param_lethality[subs],grand.res[subs,"mean_21_50"],type="l",lty=2)
	subs<-(param_sex==0.4)&(param_selfish==100)
	lines(param_lethality[subs],grand.res[subs,"mean_21_50"],type="l",lty=1)
	...
	subs<-(param_sex==0.9)&(param_selfish==10)&(param_sexresist==0.05)
	plot(param_lethality[subs],grand.res[subs,"mean_21_50"],ylim=c(0.5,1.0),ylab="",xlab="",type="l",las=1,cex.axis=cx,cex.lab=cx,lty=3)
	subs<-(param_sex==0.9)&(param_selfish==20)&(param_sexresist==0.05)
	lines(param_lethality[subs],grand.res[subs,"mean_21_50"],type="l",lty=2)
	subs<-(param_sex==0.9)&(param_selfish==100)&(param_sexresist==0.05)
	lines(param_lethality[subs],grand.res[subs,"mean_21_50"],type="l",lty=1)
...
write.csv(grand.res,file="DiploidGeneDriveResults.csv",row.names=F)